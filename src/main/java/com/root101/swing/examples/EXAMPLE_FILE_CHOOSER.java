 ...
 */
public class EXAMPLE_FILE_CHOOSER extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public EXAMPLE_FILE_CHOOSER() {
        initComponents();
        ...
        vlc.add(MaterialFileChoosersFactory.build(), true);
        vlc.add(MaterialFileChoosersFactory.buildIcon(), true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EXAMPLE_FILE_CHOOSER().setVisible(true);
            }
        });
    }
