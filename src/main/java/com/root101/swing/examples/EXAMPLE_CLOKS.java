 ...
 */
public class EXAMPLE_CLOKS extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public EXAMPLE_CLOKS() {
        initComponents();

        VerticalLayoutContainer.builder vlc = VerticalLayoutContainer.builder();
        vlc.add(MaterialClockFactory.buildClasic(), true);
        vlc.add(MaterialClockFactory.buildDigitalCircle(), true);
        vlc.add(MaterialClockFactory.buildDigitalText(), true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EXAMPLE_CLOKS().setVisible(true);
            }
        });
    }
