package com.root101.swing.ui.shadows;
...
/**
 * Implements a DropShadow for components. In general, the
 * mdlaf.shadows.DropShadowBorder will work with any rectangular components that
 * do not have a default border installed as part of the look and feel, or
 * otherwise. For example, mdlaf.shadows.DropShadowBorder works wonderfully with
