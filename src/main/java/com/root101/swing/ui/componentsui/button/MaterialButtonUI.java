package com.root101.swing.ui.componentsui.button;
...
public class MaterialButtonUI extends MetalButtonUI {
    ...
    public static ComponentUI createUI(final JComponent c) {
        if (c instanceof MaterialComponent) {
            return new javax.swing.plaf.basic.BasicButtonUI();
        }
    ...
    public void installUI(JComponent c) {
        ...
        button.addMouseListener(MaterialUIMovement.getMovement(button, MaterialColors.BLUEGREY_100));
