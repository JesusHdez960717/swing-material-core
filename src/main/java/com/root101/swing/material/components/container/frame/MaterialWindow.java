 ...
 */
package com.root101.swing.material.components.container.frame;
...
public class MaterialWindow extends JFrame implements MaterialComponent {
    ...
    public MaterialWindow() {
        ...
        if (Utils.isTranslucencySupported()) {
            setBackground(MaterialColors.AMBERA_100);
    ...
    public MaterialWindow dark() {
        getContentPane().setBackground(MaterialColors.GREY_850);
        getContentPane().setForeground(MaterialColors.WHITE);
        return this;
    }
    ...
    public MaterialWindow light() {
        getContentPane().setBackground(MaterialColors.GREY_50);
        getContentPane().setForeground(MaterialColors.GREY_800);
        return this;
    }
     ...
     *
     * @param x the <i>x</i>-coordinate of the new location's top-left corner in
     * the parent's coordinate space
     * @param y the <i>y</i>-coordinate of the new location's top-left corner in
     * the parent's coordinate space
     ...
     *
     * @param x the x-coordinate of the new location's top-left corner in the
     * desktop
     * @param y the y-coordinate of the new location's top-left corner in the
     * desktop
     */
     ...
     * might provide inaccurate results unless you take into account the margin
     * constants found in {@link MaterialShadow}. In order to make things easier
     * to handle, it is preferable to use
     * {@link #setWindowLocation(java.awt.Point)}.
     *
     ...
     * consideration the shadow offsets so you don't have to worry about it.
     *
     * @param p the point defining the top-left corner of the new location in
     * the desktop
     */
     ...
     * constants found in {@link MaterialShadow}. In order to make things easier
     * to handle, it is preferable to use
     * {@link #setWindowSize(java.awt.Dimension)}.
     *
    ...
    protected class ShadowPane extends JPanel {
        ...
        /**
         * Checks if this {@link ShadowPane} is deployed or not. When deployed,
         * this panel will display continously a shadow below the window.
         *
        ...
        protected void paintComponent(Graphics g) {
            if (isDeployed()) {
                ...
                g2.drawImage(shadow.render(getWidth(), getHeight(), 1, 2, MaterialShadow.Type.SQUARE), 0, 0, null);

                g2.setClip(new RoundRectangle2D.Float(MaterialShadow.OFFSET_LEFT, MaterialShadow.OFFSET_TOP,
