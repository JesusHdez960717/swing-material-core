 ...
 */
public abstract class MaterialTextField<T> extends JTextField implements TextMaxLength, TextExtra, Iconable, BindableComponent<T>, Line, Wrong, MaterialComponent, FloatingLabel {
