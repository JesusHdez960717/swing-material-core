...
//        this.addPostValidation(new RangeValidation(0f, 100f, GreaterThatCeroValidation.WRONG_TEXT, initial + "tiene que estar entre 0 y 100, incluyéndolos."));//TODO: textField
    }
}
