...
public class _MaterialPanelActions extends _PanelGradient {
    ...
    private final _MaterialButtonIconTranspRect buttonDelete = new com.jhw.swing.material.components.button._MaterialButtonIconTranspRect();
    private final _MaterialButtonIconTranspRect buttonEdit = new com.jhw.swing.material.components.button._MaterialButtonIconTranspRect();
    private final _MaterialButtonIconTranspRect buttonView = new com.jhw.swing.material.components.button._MaterialButtonIconTranspRect();

    private final ArrayList<_MaterialButtonIconTranspRect> extras = new ArrayList<>();
    ...
    public void addExtras(ArrayList<_MaterialButtonIconTranspRect> ex) {
        this.extras.clear();
    ...
    private void personalize() {
        ...
        for (_MaterialButtonIconTranspRect c : extras) {
            _MaterialButtonIconTranspRect act = c.clone();
            if (act.isVisible()) {
                this.add(act);
            }
        }
    ...
    public static class builder {
        ...
        public builder extra(_MaterialButtonIconTranspRect c) {
            this.extras.add(c);
            return this;
        }
